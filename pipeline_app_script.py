...
mutant_codons = ['AAA', 'AAC', 'AAG', 'AAT', 'ACA', 'ACC', 'ACG', 'ACT', 'AGA', 'AGC', 'AGG', 'AGT', 'ATA', 'ATC', 'ATG', 
                 ...
                 'GGT', 'GTA', 'GTC', 'GTG', 'GTT', 'TAA', 'TAC', 'TAG', 'TAT', 'TCA', 'TCC', 'TCG', 'TCT', 'TGA', 'TGC', 
...
diseases = ['B-Chronic lymphocytic leukemia', 'Bladder carcinoma', 'Breast carcinoma', 'Colorectal carcinoma', 
            ...
            'Pancreatic carcinoma', 'Other']

# List of Variant Types
variant_types = ['DEL', 'INS', 'SNP', 'DNP', 'ONP']
...
HG38_Start = st.text_input("Enter HG38 Start site for TP53 mutation:")
...
if predict_button:
    ...
    if prediction == 1:
        ...
        st.write("Unknown")
    st.write("Note: This model has a prediction accuracy of 93%.")
else:
